...
// If user did not give input of btnText than set it default value which is 'Visit Me'
export default function Card({name,btnText='Visit Me'}){  // destructure of object props object.
